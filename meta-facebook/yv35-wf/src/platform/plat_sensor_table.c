...
sensor_cfg plat_sensor_config[] = {
	...
	{ SENSOR_NUM_TEMP_TMP75, sensor_dev_tmp75, I2C_BUS3, TMP75_MB_ADDR, TMP75_TEMP_OFFSET,
	  stby_access, 0, 0, SAMPLE_COUNT_DEFAULT, 0, SENSOR_INIT_STATUS, NULL, NULL, NULL, NULL,
	  NULL },
	{ SENSOR_NUM_TEMP_SSD0, sensor_dev_nvme, I2C_BUS5, SSD0_ADDR, SSD0_OFFSET, dc_access, 0,
	  0, SAMPLE_COUNT_DEFAULT, 0, SENSOR_INIT_STATUS, NULL, NULL,
	  NULL, NULL, NULL },
	{ SENSOR_NUM_TEMP_SSD1, sensor_dev_nvme, I2C_BUS6, SSD0_ADDR, SSD0_OFFSET, dc_access, 0,
	  0, SAMPLE_COUNT_DEFAULT, 0, SENSOR_INIT_STATUS, NULL, NULL,
	  NULL, NULL, NULL },
	{ SENSOR_NUM_TEMP_SSD2, sensor_dev_nvme, I2C_BUS7, SSD0_ADDR, SSD0_OFFSET, dc_access, 0,
	  0, SAMPLE_COUNT_DEFAULT, 0, SENSOR_INIT_STATUS, NULL, NULL,
	  NULL, NULL, NULL },
