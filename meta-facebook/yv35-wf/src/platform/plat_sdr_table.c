...
SDR_Full_sensor plat_sdr_table[] = {
	/*                Temperature Monitoring              */
	{
		...
		0x00, // owner lun
		SENSOR_NUM_TEMP_P0V9A_ASICD, // sensor number
	...
	},
	{
		...
		SELF_I2C_ADDRESS << 1, // owner id
		0x00, // owner lun
		SENSOR_NUM_TEMP_P0V9A_ASICA1, // sensor number
	...
	},
	{
		...
		SELF_I2C_ADDRESS << 1, // owner id
		0x00, // owner lun
		SENSOR_NUM_TEMP_P0V9A_ASICA2, // sensor number
	...
	},
	{
		...
		SELF_I2C_ADDRESS << 1, // owner id
		0x00, // owner lun
		SENSOR_NUM_TEMP_PVDDQ_AB, // sensor number
	...
	/*                Voltage Monitoring               */
	{
		...
		SELF_I2C_ADDRESS << 1, // owner id
		0x00, // owner lun
		SENSOR_NUM_VOL_PVPP_AB_R, // sensor number
	...
	},	
	{
		...
		SELF_I2C_ADDRESS << 1, // owner id
		0x00, // owner lun
		SENSOR_NUM_VOL_P1V2_E1S, // sensor number
	...
	},
	{
		...
		SELF_I2C_ADDRESS << 1, // owner id
		0x00, // owner lun
		SENSOR_NUM_VOL_P0V9A_ASICD, // sensor number
	...
	},
	{
		...
		SELF_I2C_ADDRESS << 1, // owner id
		0x00, // owner lun
		SENSOR_NUM_VOL_P0V9A_ASICA1, // sensor number
	...
	},
	{
		...
		SELF_I2C_ADDRESS << 1, // owner id
		0x00, // owner lun
		SENSOR_NUM_VOL_P0V9A_ASICA2, // sensor number
	...
	},
	{
		...
		SELF_I2C_ADDRESS << 1, // owner id
		0x00, // owner lun
		SENSOR_NUM_VOL_PVDDQ_AB, // sensor number
	...
	},
	{
		...
		SELF_I2C_ADDRESS << 1, // owner id
		0x00, // owner lun
		SENSOR_NUM_VOL_P12V_E1S, // sensor number
	...
	},
	{
		...
		SELF_I2C_ADDRESS << 1, // owner id
		0x00, // owner lun
		SENSOR_NUM_VOL_VDD_P1V2, // sensor number
	...
	},
	{
		...
		SELF_I2C_ADDRESS << 1, // owner id
		0x00, // owner lun
		SENSOR_NUM_VOL_VDD_P1V8, // sensor number
	...
	},
	{
		...
		SELF_I2C_ADDRESS << 1, // owner id
		0x00, // owner lun
		SENSOR_NUM_VOL_P3V3_E1S, // sensor number
	...
	/*                Current Monitoring                */
	{
		...
		SELF_I2C_ADDRESS << 1, // owner id
		0x00, // owner lun
		SENSOR_NUM_CUR_PVPP_AB_R, // sensor number
	...
	},
	{
		...
		SELF_I2C_ADDRESS << 1, // owner id
		0x00, // owner lun
		SENSOR_NUM_CUR_P1V2_E1S, // sensor number
	...
	},
	{
		...
		SELF_I2C_ADDRESS << 1, // owner id
		0x00, // owner lun
		SENSOR_NUM_CUR_P0V9A_ASICD, // sensor number
	...
	},
	{
		...
		SELF_I2C_ADDRESS << 1, // owner id
		0x00, // owner lun
		SENSOR_NUM_CUR_P0V9A_ASICA1, // sensor number
	...
	},
	{
		...
		SELF_I2C_ADDRESS << 1, // owner id
		0x00, // owner lun
		SENSOR_NUM_CUR_P0V9A_ASICA2, // sensor number
	...
	},
	{
		...
		SELF_I2C_ADDRESS << 1, // owner id
		0x00, // owner lun
		SENSOR_NUM_CUR_PVDDQ_AB, // sensor number
	...
	/*                Power Monitoring                */
	{
		...
		SELF_I2C_ADDRESS << 1, // owner id
		0x00, // owner lun
		SENSOR_NUM_PWR_PVPP_AB_R, // sensor number
	...
	},
	{
		...
		SELF_I2C_ADDRESS << 1, // owner id
		0x00, // owner lun
		SENSOR_NUM_PWR_P1V2_E1S, // sensor number
	...
	},
	{
		...
		SELF_I2C_ADDRESS << 1, // owner id
		0x00, // owner lun
		SENSOR_NUM_PWR_P0V9A_ASICD, // sensor number
	...
	},
	{
		...
		SELF_I2C_ADDRESS << 1, // owner id
		0x00, // owner lun
		SENSOR_NUM_PWR_P0V9A_ASICA1, // sensor number
	...
	},
	{
		...
		SELF_I2C_ADDRESS << 1, // owner id
		0x00, // owner lun
		SENSOR_NUM_PWR_P0V9A_ASICA2, // sensor number
	...
	},
	{
		...
		SELF_I2C_ADDRESS << 1, // owner id
		0x00, // owner lun
		SENSOR_NUM_PWR_PVDDQ_AB, // sensor number
